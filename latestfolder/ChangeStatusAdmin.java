...
public class ChangeStatusAdmin extends javax.swing.JFrame {
    ...
    private void b_changeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_b_changeActionPerformed
        ...
        try {
            ...
            stmt=con.prepareStatement("SELECT * FROM proj.COMPLAINT_REG WHERE C_NUM=?;");
            stmt.setString(1,tf_entercomplaintnumber.getText());
            ResultSet rs=stmt.executeQuery();
            if(rs.next()) {
                stmt=con.prepareStatement("UPDATE `proj`.`COMPLAINT_REG` SET `STATUS` = ? WHERE (`C_NUM` = ?);");
                stmt.setString(1, (String) cb_status.getSelectedItem());
                stmt.setString(2,tf_entercomplaintnumber.getText());
                if(stmt.executeUpdate()!=1) {
                    JOptionPane.showMessageDialog(null,"Status couldn't be changed");
                }
                else {
                ...
                JOptionPane.showMessageDialog(null,"No such complaint number");
            }
