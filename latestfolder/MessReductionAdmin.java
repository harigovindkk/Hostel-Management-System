...
public class MessReductionAdmin extends javax.swing.JFrame {
    ...
    private void fetch()
    {
        try
        {
            ...
            stmt=con.prepareStatement("select REQ_NO,USERID,FROM_DATE,TO_DATE,DATE_SUBMITTED,REASON,STATUS from proj.MESS_REDUCTION_REG");
    ...
    private void b_updateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_b_updateActionPerformed
        ...
        try {
            ...
            con = new Connector().getCon();
            stmt=con.prepareStatement("UPDATE `proj`.`MESS_REDUCTION_REG` SET `STATUS` = ? WHERE (`REQ_NO` = ?);");
