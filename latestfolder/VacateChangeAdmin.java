...
public class VacateChangeAdmin extends javax.swing.JFrame {
    ...
    private void fetch1()
    {
        try
        {
            ...
            stmt=con.prepareStatement("select REQ_NO,USER_ID,REASON,APPLIED_DATE,STATUS from proj.HOSTEL_CHANGE");
    ...
    private void fetch2()
    {
        ...
        {
            con = new Connector().getCon();
            stmt=con.prepareStatement("select REQ_NO,USER_ID,REQUIRED_ROOM,REASON,APPLIED_DATE,STATUS from proj.ROOM_CHANGE");
            ResultSet rs=stmt.executeQuery();
