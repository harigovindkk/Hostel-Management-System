...
public class WelcomeScreen extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        try {
            jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/hari/tkm_hostel.jpg"))); // NOI18N
            jLabel1.setText("jLabel1");
            jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/hari/tkm_hostel.jpg"))); // NOI18N
    ...
    private void b_signupActionPerformed(java.awt.event.ActionEvent evt) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new RegistrationWindow(true).setVisible(true);
            }
        });  
    }
