...
public class StudentMessBill extends javax.swing.JFrame {
    ...
    public void fetch()
   {
     try
     {
         ...
         PreparedStatement pst=con.prepareStatement("SELECT MONTH,YEAR,FINAL_AMOUNT from proj.COMMON_MESS_BILL  order by MONTH DESC;");
...
try
    ...
    public void main() {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(StudentMessBill.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
